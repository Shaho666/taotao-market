...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="苏妲己"/>
		...
		<input type="hidden" name="orderShipping.receiverDistrict" value="武侯区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="武侯区001号"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">苏妲己</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">158****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">成都 武侯区 一环路</div>
						<div class="adr-m" limit="30">一环路南四段xxxxxxxxx</div>
