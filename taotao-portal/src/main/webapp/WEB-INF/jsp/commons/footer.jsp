	...
	<div id="service-2013">
		...
		<dl class="fore5">
			...
			<dd>		
				...
				<div><a href="#" target="_blank" rel="nofollow">淘淘E卡</a></div>
				<div><a href="#" target="_blank" rel="nofollow">节能补贴</a></div>
				<div><a href="#" target="_blank" rel="nofollow">淘淘通信</a></div>
			</dd>
		</dl>
		<div class="fr">
...
var A="<strong>热门搜索：</strong><a href='#' target='_blank' style='color:#ff0000' clstag='homepage|keycount|home2013|03b1'>校园之星</a><a href='#' target='_blank'>办公打印</a><a href='#' target='_blank'>美菱冰箱</a><a href='#' target='_blank'>无肉不欢</a><a href='#' target='_blank'>万件好货</a><a href='#' target='_blank'>iPhone6</a><a href='#' target='_blank'>哈利波特</a><a href='#' target='_blank'>美模接驾</a>";
