...
var Floors = {cacheData: null,data: function(t) {
        ...
        this.pin && (n.pin = this.pin), $.ajax({url: "#" ,data: n,dataType: "jsonp",success: function(e) {
                t.set(e)
            }})
    },set: function(t) {
        this.skus = [];
...
(function() {
    ...
    new BackPanelNew({id: "backpanel0708",start: 10}).init({text: "\u8fd4\u56de\u9876\u90e8",fn: function() {
        ...
        }}).add({cName: "survey",text: "\u6211\u8981\u53cd\u9988",target: "_blank",href: "#"}), pageConfig.backTopFloor = new BackPanelNew({id: "backpanel-floor",start: 10,fadeIn: 500,onShow: function(i) {
        ...
        var t = $("#shortcut-2013 .fl").eq(0).find(".fore1"), e = '            <li class="fore2 jd-wx-qrcode">                <a href="#none"><i class="i-qrcode"></i>关注淘淘</a>                <div class="qrcode-show">                    <span class="arrow">                        <i class="layer1"></i><i class="layer2"></i>                    </span>                </div>            </li>';
